...
# python run_survey.py 'input_path' 'output_path'
# python run_survey.py '../data/Percentage Project Example.xlsx' '../results'
...
def main():
    ...
    for sheet_name in sheets_to_read:
        ...
        data_groups = extract_data_groups(input_path, sheet_name)
    ...
    final_df.to_csv(f'{output_path}/survey_percentage[{current_year}].csv', index=True)
